...
const onlyKyiv = news => news.filter(({title})=>!title.includes('Львов')&&!title.includes('Винниц')&&!title.includes('Харьков')&&!title.includes('Одесс')&&!title.includes('Николаев')&&!title.includes('Мариуполь')&&!title.includes('Полтав')&&!title.includes('Чернигов')&&!title.includes('Тернопол')&&!title.includes('Славутич'))
